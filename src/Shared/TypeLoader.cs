...
namespace Microsoft.Build.Shared
{
    ...
    internal class TypeLoader
    {
        ...
        private static (Assembly, MetadataLoadContext) LoadAssemblyUsingMetadataLoadContext(AssemblyLoadInfo assemblyLoadInfo)
        {
        ...
        private class AssemblyInfoToLoadedTypes
        {
            ...
            private LoadedType GetLoadedTypeFromTypeNameUsingMetadataLoadContext(string typeName)
            {
                return _publicTypeNameToLoadedType.GetOrAdd(typeName, typeName =>
                {
                    ...
                    // Create a local MetadataLoadContext for this specific operation to avoid race conditions.
                    // Each thread gets its own context that it manages independently.
                    ...
                    {
                        // Always dispose the context when done, regardless of success or failure
                        context?.Dispose();
                    }
                });
            }
